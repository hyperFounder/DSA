...
- DFS (**Stack/Recursion)**: Depth first search algorithms explore as deep as possible along each branch before **backtracking**. There are 3 primary forms of DFS which are mentioned below.
